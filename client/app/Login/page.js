  ...
  async function onLogin(e) {
    ...
    try {
      ...
      if (response.status === 404) {
        ...
        router.push("/Chat1v1"); // Redirect to Chat1v1 page
      } else {
    ...
    <>
      ...
      <div className="bg-black flex items-center justify-center h-screen">
        ...
        >
          ...
          {errorMessage && (
            <div className="mb-4 text-red-500 text-center" aria-live="assertive">
              {errorMessage}
            </div>
          )}
          <form onSubmit={onLogin}>
            <div className="mb-4">
              <label htmlFor="username" className="block text-sm font-medium text-red-400">
                Username
              </label>
              <motion.input
                type="text"
